...
//#define SPI_BUS_CONFIG_SIMPLEX_TXONLY	3	//remove this line cause in CR1 10th bit can work this line
#define SPI_BUS_CONFIG_SIMPLEX_RXONLY	3	//chuyen 4 -> 3
...
void SPI_SSOEConfig(SPI_RegDef_t *pSPIx, uint8_t Enordi);		//this function used to enable NSS output
